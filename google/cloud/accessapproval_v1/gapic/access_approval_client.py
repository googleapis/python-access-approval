...
from google.cloud.accessapproval_v1.gapic.transports import access_approval_grpc_transport
...
class AccessApprovalClient(object):
    ...
    def list_approval_requests(
        ...
        if 'list_approval_requests' not in self._inner_api_calls:
            self._inner_api_calls['list_approval_requests'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_approval_requests'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
    ...
    def get_approval_request(
        ...
        if 'get_approval_request' not in self._inner_api_calls:
            self._inner_api_calls['get_approval_request'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        request = accessapproval_pb2.GetApprovalRequestMessage(
            name=name,
        )
        if metadata is None:
            metadata = []
        ...
        return self._inner_api_calls['get_approval_request'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def approve_approval_request(
        ...
        if 'approve_approval_request' not in self._inner_api_calls:
            self._inner_api_calls['approve_approval_request'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['approve_approval_request'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def dismiss_approval_request(
        ...
        if 'dismiss_approval_request' not in self._inner_api_calls:
            self._inner_api_calls['dismiss_approval_request'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        request = accessapproval_pb2.DismissApprovalRequestMessage(
            name=name,
        )
        if metadata is None:
            metadata = []
        ...
        return self._inner_api_calls['dismiss_approval_request'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def get_access_approval_settings(
        ...
        if 'get_access_approval_settings' not in self._inner_api_calls:
            self._inner_api_calls['get_access_approval_settings'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_access_approval_settings,
                default_retry=self._method_configs['GetAccessApprovalSettings'].retry,
                default_timeout=self._method_configs['GetAccessApprovalSettings'].timeout,
                client_info=self._client_info,
            )

        request = accessapproval_pb2.GetAccessApprovalSettingsMessage(
            name=name,
        )
        if metadata is None:
            metadata = []
        ...
        return self._inner_api_calls['get_access_approval_settings'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def update_access_approval_settings(
        ...
        if 'update_access_approval_settings' not in self._inner_api_calls:
            self._inner_api_calls['update_access_approval_settings'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.update_access_approval_settings,
                default_retry=self._method_configs['UpdateAccessApprovalSettings'].retry,
                default_timeout=self._method_configs['UpdateAccessApprovalSettings'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['update_access_approval_settings'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def delete_access_approval_settings(
        ...
        if 'delete_access_approval_settings' not in self._inner_api_calls:
            self._inner_api_calls['delete_access_approval_settings'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.delete_access_approval_settings,
                default_retry=self._method_configs['DeleteAccessApprovalSettings'].retry,
                default_timeout=self._method_configs['DeleteAccessApprovalSettings'].timeout,
                client_info=self._client_info,
            )

        request = accessapproval_pb2.DeleteAccessApprovalSettingsMessage(
            name=name,
        )
        if metadata is None:
            metadata = []
        ...
        self._inner_api_calls['delete_access_approval_settings'](request, retry=retry, timeout=timeout, metadata=metadata)
