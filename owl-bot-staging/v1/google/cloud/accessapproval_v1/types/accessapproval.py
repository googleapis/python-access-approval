...
class ApproveDecision(proto.Message):
    ...
    approve_time = proto.Field(proto.MESSAGE, number=1,
...
class DismissDecision(proto.Message):
    ...
    dismiss_time = proto.Field(proto.MESSAGE, number=1,
        message=timestamp.Timestamp,
    )
...
class ApprovalRequest(proto.Message):
    ...
    requested_resource_properties = proto.Field(proto.MESSAGE, number=9,
        message='ResourceProperties',
    )

    requested_reason = proto.Field(proto.MESSAGE, number=3,
        message='AccessReason',
    )

    requested_locations = proto.Field(proto.MESSAGE, number=4,
        message='AccessLocations',
    )

    request_time = proto.Field(proto.MESSAGE, number=5,
        message=timestamp.Timestamp,
    )

    requested_expiration = proto.Field(proto.MESSAGE, number=6,
        message=timestamp.Timestamp,
    )

    approve = proto.Field(proto.MESSAGE, number=7, oneof='decision',
        message='ApproveDecision',
    )

    dismiss = proto.Field(proto.MESSAGE, number=8, oneof='decision',
...
class EnrolledService(proto.Message):
    ...
    enrollment_level = proto.Field(proto.ENUM, number=2,
...
class AccessApprovalSettings(proto.Message):
    ...
    enrolled_services = proto.RepeatedField(proto.MESSAGE, number=3,
...
class ListApprovalRequestsResponse(proto.Message):
    ...
    approval_requests = proto.RepeatedField(proto.MESSAGE, number=1,
