...
class AccessApprovalClient(metaclass=AccessApprovalClientMeta):
    ...
    @staticmethod
    def access_approval_service_account_path(project: str,) -> str:
        """Returns a fully-qualified access_approval_service_account string."""
        return "projects/{project}/serviceAccount".format(project=project, )
    ...
    def approval_request_path(project: str,approval_request: str,) -> str:
        ...
        return "projects/{project}/approvalRequests/{approval_request}".format(project=project, approval_request=approval_request, )

    @staticmethod
    def parse_approval_request_path(path: str) -> Dict[str,str]:
        """Parses a approval_request path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/approvalRequests/(?P<approval_request>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def invalidate_approval_request(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.invalidate_approval_request]
    ...
    def get_access_approval_settings(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_access_approval_settings]
    ...
    def update_access_approval_settings(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_access_approval_settings]
    ...
    def delete_access_approval_settings(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_access_approval_settings]
    ...
    def get_access_approval_service_account(self,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, accessapproval.GetAccessApprovalServiceAccountMessage):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_access_approval_service_account]
