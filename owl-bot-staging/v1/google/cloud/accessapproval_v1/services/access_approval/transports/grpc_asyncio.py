...
class AccessApprovalGrpcAsyncIOTransport(AccessApprovalTransport):
    ...
    def update_access_approval_settings(self) -> Callable[
        ...
        if 'update_access_approval_settings' not in self._stubs:
            self._stubs['update_access_approval_settings'] = self.grpc_channel.unary_unary(
    ...
    def delete_access_approval_settings(self) -> Callable[
        ...
        if 'delete_access_approval_settings' not in self._stubs:
            self._stubs['delete_access_approval_settings'] = self.grpc_channel.unary_unary(
    ...
    def get_access_approval_service_account(self) -> Callable[
        ...
        if 'get_access_approval_service_account' not in self._stubs:
            self._stubs['get_access_approval_service_account'] = self.grpc_channel.unary_unary(
