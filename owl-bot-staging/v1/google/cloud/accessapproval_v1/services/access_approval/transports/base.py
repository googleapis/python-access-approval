...
class AccessApprovalTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_approval_requests: gapic_v1.method.wrap_method(
                self.list_approval_requests,
            ...
            self.get_approval_request: gapic_v1.method.wrap_method(
                self.get_approval_request,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=60.0,
                    multiplier=1.3,
            ...
            self.approve_approval_request: gapic_v1.method.wrap_method(
                self.approve_approval_request,
                default_timeout=600.0,
                client_info=client_info,
            ),
            self.dismiss_approval_request: gapic_v1.method.wrap_method(
                self.dismiss_approval_request,
                default_timeout=600.0,
                client_info=client_info,
            ),
            ...
            self.update_access_approval_settings: gapic_v1.method.wrap_method(
                self.update_access_approval_settings,
                default_timeout=600.0,
                client_info=client_info,
            ),
    ...
    @property
    def list_approval_requests(self) -> typing.Callable[
            [accessapproval.ListApprovalRequestsMessage],
            typing.Union[
                accessapproval.ListApprovalRequestsResponse,
                typing.Awaitable[accessapproval.ListApprovalRequestsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_approval_request(self) -> typing.Callable[
    ...
    @property
    def approve_approval_request(self) -> typing.Callable[
    ...
    @property
    def dismiss_approval_request(self) -> typing.Callable[
    ...
    @property
    def get_access_approval_settings(self) -> typing.Callable[
            [accessapproval.GetAccessApprovalSettingsMessage],
            typing.Union[
                accessapproval.AccessApprovalSettings,
                typing.Awaitable[accessapproval.AccessApprovalSettings]
            ]]:
        raise NotImplementedError()

    @property
    def update_access_approval_settings(self) -> typing.Callable[
    ...
    @property
    def delete_access_approval_settings(self) -> typing.Callable[
